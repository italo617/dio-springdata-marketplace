...
public class MongoEventMetadataRepository implements EventMetadataRepository {
    ...
    private static EventMetadata mapper(dio.marketplace.catalog.infrasctructure.persistence.entity.EventMetadata eventMetadata) {
    ...
    private static Seat mapper(dio.marketplace.catalog.infrasctructure.persistence.entity.EventMetadata.Seat seat) {
        return new Seat(new SeatId(seat.getCode()), new SectorId(seat.getSectorName()));
    }

    private static Sector mapper(dio.marketplace.catalog.infrasctructure.persistence.entity.EventMetadata.Sector sector) {
